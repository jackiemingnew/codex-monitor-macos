...
- 详情页使用多 tab 模式：`Codex`、`Skills`、`Codex Radar`、`CLIProxyAPI`、`NewAPI`、`Sub2API`。
...
- `Codex`：本机 Codex 固定/自适应刷新、额度来源、任务范围和历史用量显示。
...
- Multi-tab detail panel: `Codex`, `Skills`, `Codex Radar`, `CLIProxyAPI`, `NewAPI`, and `Sub2API`.
